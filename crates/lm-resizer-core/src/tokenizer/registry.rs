...
//!
//! Mirrors `MODEL_PATTERNS` in `lm-resizer/tokenizers/registry.py`. Three
...
///
/// Patterns and ordering match `lm-resizer.tokenizers.registry.MODEL_PATTERNS`
...
///
/// ```no_run
/// use lm_resizer_core::tokenizer::try_register_hf;
