//! Token counting for lm-resizer transforms.
//!
//! Mirrors the public surface of the Python `lm-resizer.tokenizers` package:
...
//!
//! # What this is NOT
//! - Not used by `lm-resizer-proxy` yet (Stage 2 is library-only; no production
//!   wiring).
