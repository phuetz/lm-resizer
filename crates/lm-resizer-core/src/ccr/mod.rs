...
//! end-to-end.
//!
//! Mirrors the semantics of Python's [`CompressionStore`] (`lm-resizer/
...
//!
//! [`CompressionStore`]: internal CCR storage contract
...
pub fn compute_key(payload: &[u8]) -> String {
    ...
    // (`[a-f0-9]{24}`) — see `lm-resizer/ccr/tool_injection.py:211`.
...
/// calls `lm_resizer_retrieve`. Format is intentionally fixed across
