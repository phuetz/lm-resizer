//! Unified-diff compressor — Rust port of `lm-resizer.transforms.diff_compressor`.
//!
...
/// Priority patterns matching `lm-resizer.transforms.error_detection.PRIORITY_PATTERNS_DIFF`:
...
/// `lm-resizer.cache.compression_store.CompressionStore.store`.
