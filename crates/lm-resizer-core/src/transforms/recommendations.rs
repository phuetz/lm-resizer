...
//!
//! 1. The Python `lm-resizer.cli.toin_publish` CLI walks the on-disk TOIN
...
/// not propagate.
pub const RECOMMENDATIONS_PATH_ENV_VAR: &str = "lm-resizer_RECOMMENDATIONS_PATH";
...
///
/// Honors `lm-resizer_RECOMMENDATIONS_PATH` for prod overrides; falls
